...
# pragma omp for
  for (size_t i = 0; i < sz/1024/8; i ++) {
    ...
    int64_t stride = 64;
    _tile_loadd(0, index, 64);
    _tile_loadd(1, index+64, 64);
    _tile_loadd(2, index+64*2, 64);
    _tile_loadd(3, index+64*3, 64);
    _tile_loadd(4, index+64*4, 64);
    _tile_loadd(5, index+64*5, 64);
    _tile_loadd(6, index+64*6, 64);
    _tile_loadd(7, index+64*7, 64);
    // asm volatile (
    //   "tileloadd (%0, %1), %%tmm0;"
    //   "tileloadd 1024(%0, %1), %%tmm1;"
    //   "tileloadd 2 * 1024(%0, %1), %%tmm2;"
    //   "tileloadd 3 * 1024(%0, %1), %%tmm3;"
    //   "tileloadd 4 * 1024(%0, %1), %%tmm4;"
    //   "tileloadd 5 * 1024(%0, %1), %%tmm5;"
    //   "tileloadd 6 * 1024(%0, %1), %%tmm6;"
    //   "tileloadd 7 * 1024(%0, %1), %%tmm7;"
    //   : : "r" (index),/*, "r" (dst)*/
    //       "r" (stride)
    //   );
  }
